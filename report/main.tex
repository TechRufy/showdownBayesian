...
\{ alberto.genovese, christian.dibuo \}@studio.unibo.it
}
\maketitle
...
It was created by Satoshi Tajiri with assistance from Ken Sugimori. 
The game is based on battles between two Pokémon, where each of them can choose between 4 different moves, in particular moves can be enhanced or buffed on the basis of the type of the Pokémon who hit or is hit form the move.
Our objective is to exploit the efficiency of the use of Bayesian Networks in the choice of the best move that can be played by the pokemon with respect to other algorithms, such as ...
\end{quote}
\end{abstract}
